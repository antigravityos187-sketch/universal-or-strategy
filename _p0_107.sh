...
<execute_command>
<command>
cat > docs/brain/EPIC-CCN-107/manifest.json << 'EOF'
{
...
<execute_command>
<command>
ls -lh docs/brain/EPIC-CCN-107/00-hotspots.md && wc -l docs/brain/EPIC-CCN-107/00-hotspots.md</command>
<cwd>/home/malhitticrypto/universal-or-strategy</cwd>
</execute_command>
```
...
<execute_command>
<command>
ls -lh docs/brain/EPIC-CCN-107/manifest.json && cat docs/brain/EPIC-CCN-107/manifest.json | head -20</command>
<cwd>/home/malhitticrypto/universal-or-strategy</cwd>
</execute_command>
```
