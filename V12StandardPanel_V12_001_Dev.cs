...
namespace NinjaTrader.NinjaScript.Indicators
{
    public class V12StandardPanel_V12_001_Dev : Indicator
    {
        ...
        private Border CreateSection0_Identity()
        {
            ...
            Button closeBtnRow = CreateButton("[X]", 28, RedBg, Brushes.White, RedBorder);
        ...
        private void SelectConfigMode(string mode, Button clickedBtn)
        {
            ...
            // Switch to new mode (keep current count)
            ...
            // Load new mode's settings for CURRENT count (or defaults if first use)
            ApplySettings(fullConfig.GetSettings(mode, selectedTargetCount));
