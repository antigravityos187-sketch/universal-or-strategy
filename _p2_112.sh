...
cat > /tmp/phase2_msg_112.txt << 'EOFMSG'
You are executing Phase 2 (Architecture Planning) for EPIC-CCN-112.

**Input Artifact**: Read `docs/brain/EPIC-CCN-112/01-scope-boundary.md` for scope definition.

**Your Task**: Create detailed architecture plan for the extraction.

**Output Requirements**:
1. Create `docs/brain/EPIC-CCN-112/02-architecture-plan.md` with:
...
bob --yolo /epic-plan EPIC-CCN-112 2>&1 | tee logs/phase2/EPIC-CCN-112.log
echo "DONE_EXIT=$?"
