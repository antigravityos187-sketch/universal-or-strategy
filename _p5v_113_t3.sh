...
cat > /tmp/phase5v_msg_113_t3.txt << 'EOFMSG'
You are performing INDEPENDENT VALIDATION (Tier 2) for TICKET-3 of EPIC-CCN-113.

**Input**: Read `docs/brain/EPIC-CCN-113/ticket-3-completion.md` and original ticket spec
...
**Output**: `docs/brain/EPIC-CCN-113/ticket-3-verification.md` with verdict and detailed findings
...
bob --yolo --chat-mode advanced "$(cat /tmp/phase5v_msg_113_t3.txt)" 2>&1 | tee logs/phase5v/EPIC-CCN-113-T3-VALIDATION.log
echo "DONE_EXIT=$?"
