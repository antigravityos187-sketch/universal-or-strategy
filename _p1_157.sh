...
You are in **Plan mode** for Phase 1 (Scope Definition) of epic EPIC-W7-157.

## Context
- **Epic**: EPIC-W7-157
- **Phase**: 1 (Scope Definition)
- **Input**: docs/brain/EPIC-W7-157/00-hotspots.md
- **Output**: docs/brain/EPIC-W7-157/00-scope.md

## Your Task
Read the hotspot analysis and define the refactoring scope:

1. **Read Input**: Read docs/brain/EPIC-W7-157/00-hotspots.md
2. **Define Scope**: 
   - What code will be extracted?
   - What will remain in the original method?
   - What are the boundaries?
3. **Write Output**: Create docs/brain/EPIC-W7-157/00-scope.md with:
