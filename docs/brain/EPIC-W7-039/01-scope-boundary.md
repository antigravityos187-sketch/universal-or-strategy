# EPIC-W7-039 — Phase 1.5: Scope Boundary Validation
...
**Input:** docs/brain/EPIC-W7-039/00-scope.md
...
**`ManageTrailingStops` + 2 new helper methods (to be named in Phase 2)**
...
- `ShadowEngineCheck` — confirmed not modified by this epic
...
- **Source analyzed:** `docs/brain/EPIC-W7-039/00-scope.md` (Phase 1 output)
