# Ticket 1 Completion -- EPIC-W7-152
...
**parent_method:** TryApplyConfigTarget_Value
**cyc_parent_now:** 1
**cyc_achieved:** 1
**build_passed:** true
**tests_written:** 0
...
Method `TryApplyConfigTarget_Value` in `src/V12_002.UI.IPC.Commands.Config.cs` is CYC=0 which is within CYC<=8 target.
