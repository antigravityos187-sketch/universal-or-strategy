...
| DW-B5-03 | Rule persistence across sessions (serialize/deserialize CopyRule list) | P3 | future | OPEN |
| DW-B5-04 | Spec HTML update for B3+B4 changes | P3 | future | OPEN |
...
| ID | Item | Priority | Target Block | Status |
|----|------|----------|--------------|--------|
| DW-B5-03 | Rule persistence across sessions (serialize/deserialize CopyRule list on NT shutdown/startup) | P3 | B6/future | OPEN |
| DW-B5-04 | Spec HTML update for B3/B4/B5 changes (002-trade-copier-spec.html -- BE, Shift+B, ListBox, buffer documented) | P3 | B6/future | OPEN |
