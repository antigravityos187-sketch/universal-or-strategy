# B119 Deferred Backlog

Block: B119 (DW-B128 Direction-Change Guard)
Date: 2026-08-27
...
|------|-------------|-----------|
| DW-B128 | Reversal Entry Dispatched to Flat Followers -- `DispatchCopy` blocked reversal entry to followers that are already flat via direction-change guard in `CopyEngine.DispatchCopy` | B119-T1 |

---

## New Deferred Items (B119 pipeline)

### B119-DEFER-01 -- F5 NinjaTrader 8 Compilation Gate
...
B119 changes do not affect any of these items.
...
CS0433 Globals ambiguity at CopyEngine.cs:L4093. Confirmed pre-existing and unrelated to B119.
Note: B119Tests.cs compiles cleanly; the 83 errors are in unrelated test files.  
...
|----------|-------|-------|
| Closed this block | 1 | DW-B128 |
| New deferred (B119 SIM gate) | 2 | B119-DEFER-01 (F5), B119-DEFER-02 (Reversal Guard SIM verification) |
| New deferred (B107 pipeline, post-SIM) | 1 | DW-B107 (MoveStopToBreakEven stale PTT-BE-Target-*) |
| Carry-forward from B107 (unchanged) | 2 | B107-DEFER-01 (F5), B107-DEFER-02 (Combo C live test) |
| Carry-forward from DW-B89 and earlier (unchanged) | 11 | DW-B42-01/02/03, DW-PTT-BE-FIX-01/02/03, DW-B89-DEFERRED-01/02/03/04/05/06 |
| **Total open items** | **16** | B119-DEFER-01/02, DW-B107, B107-DEFER-01/02, DW-B42-01/02/03, DW-PTT-BE-FIX-01/02/03, DW-B89-DEFERRED-01/02/03/04/05/06 |
