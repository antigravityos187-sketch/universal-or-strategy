# Ticket 1 Completion -- EPIC-W7-063
...
**parent_method:** DrainAllDispatchQueuesOnAbort
**cyc_parent_now:** 1
**cyc_achieved:** 1
**build_passed:** true
**tests_written:** 0
...
Method `DrainAllDispatchQueuesOnAbort` in `src/V12_002.SIMA.Fleet.cs` is CYC=0 which is within CYC<=8 target.
