# Ticket 1 Completion -- EPIC-W7-100
...
**parent_method:** ClosePositionsOnlyApexAccounts
**cyc_parent_now:** 1
**cyc_achieved:** 1
**build_passed:** true
**tests_written:** 0
...
Method `ClosePositionsOnlyApexAccounts` in `src/V12_002.SIMA.Flatten.cs` is CYC=0 which is within CYC<=8 target.
