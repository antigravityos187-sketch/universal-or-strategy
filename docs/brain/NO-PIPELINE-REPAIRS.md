...
| REPAIR-06 | CancelQxBracketsForFollowers guard | PttQuickExit.cs | DW-B78-02: skipIfFollower guard prevents sibling follower QX orders from being erased by subsequent follower Execute calls | 4 [Fact] | DIRECT (Director approved) -- awaiting sim test |
