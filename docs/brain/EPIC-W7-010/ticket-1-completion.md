# Ticket 1 Completion -- EPIC-W7-010
...
**parent_method:** ShowModeSpecificControls
**cyc_parent_now:** 8
**cyc_achieved:** 8
**build_passed:** true
**tests_written:** 0
...
Method `ShowModeSpecificControls` in `src/V12_002.UI.Panel.Handlers.cs` is CYC=8 which is within CYC<=8 target.
