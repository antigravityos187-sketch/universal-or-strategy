# Ticket 1 Completion -- EPIC-W7-048
...
**parent_method:** UpdateExistingPendingReplacement
**cyc_parent_now:** 1
**cyc_achieved:** 1
**build_passed:** true
**tests_written:** 0
...
Method `UpdateExistingPendingReplacement` in `src/V12_002.Trailing.StopUpdate.cs` is CYC=0 which is within CYC<=8 target.
