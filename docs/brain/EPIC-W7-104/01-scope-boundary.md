# EPIC-W7-104 — Phase 1.5: Scope Boundary Validation
...
**`SubmitAndRegisterFleetOrders` + 5 new helper methods (to be named in Phase 2)**
...
- **Source analyzed:** `docs/brain/EPIC-W7-104/00-scope.md` (Phase 1 output)
...
- **Scope statement from Phase 1:** > **Only `SubmitAndRegisterFleetOrders` and its new extracted helper methods are in scope.**

This epic covers exclusively the cyclomatic complexity reduction of `SubmitAndRegisterFleetOrders` in `src
