# EPIC-W7-132 — Phase 1.5: Scope Boundary Validation
...
**Input:** docs/brain/EPIC-W7-132/00-scope.md
...
**`SymmetryNormalizeTradeType` + 5 new helper methods (to be named in Phase 2)**
...
- **CYC baseline:** 3 (target: <= 8 after extraction)
...
- **Source analyzed:** `docs/brain/EPIC-W7-132/00-scope.md` (Phase 1 output)
...
- **Scope statement from Phase 1:** > **Only `SymmetryNormalizeTradeType` and its new extracted helper methods are in scope.**

This epic covers exclusively the cyclomatic complexity reduction of `SymmetryNormalizeTradeType` in `src/V12
