# EPIC-W7-003 — Phase 1.5: Scope Boundary Validation
...
**`IsOrderAllowed` + 3 new helper methods (to be named in Phase 2)**
...
- **Source analyzed:** `docs/brain/EPIC-W7-003/00-scope.md` (Phase 1 output)
...
- **Scope statement from Phase 1:** The **scope boundary** for EPIC-W7-003 is: the body of `IsOrderAllowed` at
[`src/V12_002.UI.Compliance.cs:323`](../../src/V12_002.UI.Compliance.cs:323)
and any new **private** helper methods extracted
