# Ticket 1 Completion -- EPIC-W7-055
...
**parent_method:** DrainPhotonQueuesOnShutdown
**cyc_parent_now:** 8
**cyc_achieved:** 8
**build_passed:** true
**tests_written:** 0
...
Method `DrainPhotonQueuesOnShutdown` in `src/V12_002.SIMA.Lifecycle.cs` is CYC=8 which is within CYC<=8 target.
