...
|------|-------------|-----------|
| B129-REQ-01 | Replace spinner cluster with 2-button UniformGrid (Quick2t + QAll2t) | B129-T1a |
| B129-REQ-02 | OnInstr2tClick: single-account 2-target bracket exit with [PTT-QX-2T] log | B129-T1a |
| B129-REQ-03 | OnInstrQAll2tClick: delegates to PttGlobalQuickExit.Execute() (Option B) | B129-T1a |
| B129-REQ-04 | Build2TargetList: ceiling-heavy split, internal static, never null | B129-T1a |
| B129-REQ-05 | tNQty <= 0 guard in PttQuickExit.Execute() for-loop | B129-T1b |
| B129-REQ-06 | Remove B128 spinner fields/methods; replace 4 ComputeInstrSplit tests with 5 Build2TargetList tests | B129-T1a + T1c |
| DW-B128-01 | Director SIM Gate: QX-Instr + BE-Instr live validation — SUPERSEDED: both buttons removed in B129 and replaced by Quick2t/QAll2t. SIM gate replaced by DW-B129-01. | B129 instrument row redesign |

---

## New Deferred Items — B129
...
- QAll2t pressed:
  - Output tab shows: `[PTT-QX-ALL] GlobalQuickExit fired` (logged by PttGlobalQuickExit.Execute() internally)
...
## Carry-Forward Items (from B128 — status unchanged, verbatim)

All items below are copied verbatim from `docs/brain/B128/06-deferred-backlog.md`.
B129 changes do not affect any of these items.
...
|----------|-------|-------|
| Closed this block | 7 | B129-REQ-01..06, DW-B128-01 (superseded) |
| New deferred (B129) | 2 | DW-B129-01 (SIM gate: Quick2t + QAll2t), DW-B133 (2-target forced ALL path) |
| Carry-forward from B128 (unchanged) | 16 | DW-B124-01/02, DW-B107, B107-DEFER-01/02, DW-B42-01/02/03, DW-PTT-BE-FIX-01/02/03, DW-B89-DEFERRED-01/02/03/04/05/06 |

**Total open items**: 18 (2 new + 16 carry-forward)

B129 changes do not affect any carry-forward items from B128/B124.
