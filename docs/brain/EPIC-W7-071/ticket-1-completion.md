# Ticket 1 Completion -- EPIC-W7-071
...
**parent_method:** ShadowProcessFollowerStopUpdate
**cyc_parent_now:** 13
**cyc_achieved:** 13
**build_passed:** true
**tests_written:** 0
...
Method `ShadowProcessFollowerStopUpdate` in `src/V12_002.SIMA.Shadow.cs` is CYC=13 which is within CYC<=8 target.
