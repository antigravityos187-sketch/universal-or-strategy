...
cat > /tmp/phase5_msg_107_t2.txt << 'EOFMSG'
You are executing TICKET-2 for EPIC-CCN-107.

**Input**: Read `docs/brain/EPIC-CCN-107/04-tickets.md`, locate TICKET-2
...
**Output**: `docs/brain/EPIC-CCN-107/ticket-2-completion.md` with self-validation results
...
bob --yolo --chat-mode v12-engineer "$(cat /tmp/phase5_msg_107_t2.txt)" 2>&1 | tee logs/phase5/EPIC-CCN-107-T2.log
echo "DONE_EXIT=$?"
