...
# Output: docs/brain/EPIC-CCN-077/01-scope-boundary.md
...
can_execute, reason = verify_can_execute('$EPIC_ID', '$PHASE', '$ranirabah')
if not can_execute:
...
started, reason = start_phase_execution('$EPIC_ID', '$PHASE', '$ranirabah')
if not started:
...
recorded, reason = fail_phase_execution('$EPIC_ID', '$PHASE', '$ranirabah', '$ERROR_MSG')
