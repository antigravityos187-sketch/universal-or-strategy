...
## Target Methods (4 methods in same file)
- Method 1: ManageCIT (CYC=19, LOC=77)
- Method 2: FlattenSinglePosition (CYC=16, LOC=76)
- Method 3: HasActiveOrPendingOrderForEntry (CYC=12, LOC=15)
- Method 4: CancelAllBracketOrdersForPosition (CYC=11, LOC=9)
- File: src/V12_002.Orders.Management.Flatten.cs
- Complexity: 19, 16, 12, 11 (target: all ≤8)
...
2. get_blast_radius(repo='universal-or-strategy', symbol='ManageCIT')
3. get_call_hierarchy(repo='universal-or-strategy', symbol_id='ManageCIT')
...
{
  "epic_id": "EPIC-002",
  "methods": ["ManageCIT", "FlattenSinglePosition", "HasActiveOrPendingOrderForEntry", "CancelAllBracketOrdersForPosition"],
  "file": "src/V12_002.Orders.Management.Flatten.cs",
  "complexity": [19, 16, 12, 11],
  "phases": {
    "0": {
      "status": "completed",
