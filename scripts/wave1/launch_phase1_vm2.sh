#!/bin/bash
# Launch Phase 1 for EPIC-006 through EPIC-010 on VM2
# Uses screen sessions for parallel execution

set -e
cd /home/malhitticrypto/universal-or-strategy

echo "Launching Phase 1 for EPIC-006 through EPIC-010..."
echo ""
...
echo "  ls docs/brain/EPIC-{006..010}/00-scope.md | wc -l"
