...
You are executing Phase 2 (Architecture Planning) for EPIC-CCN-118.

**Input Artifact**: Read `docs/brain/EPIC-CCN-118/00-scope.md` for scope definition.

**Your Task**: Create detailed architecture plan for the extraction.

**Output Requirements**:
1. Create `docs/brain/EPIC-CCN-118/02-architecture-plan.md` with:
...
bob --yolo /epic-plan EPIC-CCN-118 2>&1 | tee logs/phase2/EPIC-CCN-118.log
echo "DONE_EXIT=$?"
