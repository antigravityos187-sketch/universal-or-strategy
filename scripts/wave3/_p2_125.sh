...
You are executing Phase 2 (Architecture Planning) for EPIC-CCN-125.

**Input Artifact**: Read `docs/brain/EPIC-CCN-125/00-scope.md` for scope definition.

**Your Task**: Create detailed architecture plan for the extraction.

**Output Requirements**:
1. Create `docs/brain/EPIC-CCN-125/02-architecture-plan.md` with:
...
bob --yolo /epic-plan EPIC-CCN-125 2>&1 | tee logs/phase2/EPIC-CCN-125.log
echo "DONE_EXIT=$?"
