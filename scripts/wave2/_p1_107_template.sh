...
You are executing Phase 1 (Scope Definition) for EPIC-CCN-107.
...
bob --yolo --chat-mode plan "$(cat /tmp/phase1_msg_107.txt)" 2>&1 | tee logs/phase1/EPIC-CCN-107.log
echo "DONE_EXIT=$?"
