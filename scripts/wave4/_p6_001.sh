...
if [ ! -f "docs/brain/EPIC-CCN-001/05-completion.md" ]; then
    echo "ERROR: Missing Phase 5 completion file for EPIC-CCN-001"
    exit 1
fi
...
if [ -f "docs/brain/EPIC-CCN-001/06-completion-report.md" ]; then
    echo "SUCCESS: Phase 6 complete for EPIC-CCN-001"
    echo "File: docs/brain/EPIC-CCN-001/06-completion-report.md"
    ls -lh docs/brain/EPIC-CCN-001/06-completion-report.md
else
    echo "ERROR: No completion report created for EPIC-CCN-001"
    exit 1
fi
