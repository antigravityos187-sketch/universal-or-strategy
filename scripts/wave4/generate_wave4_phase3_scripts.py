...
# -*- coding: utf-8 -*-
"""
Wave 4 Phase 3 Script Generator
Updated from Wave 3 to use /epic-scan slash command instead of --chat-mode advanced
"""
...
# Epic configuration (Wave 4: 126-135)
EPICS = [126, 127, 128, 129, 130, 131, 132, 133, 134, 135]

def generate_phase3_script(epic_id: int) -> str:
    """Generate Phase 3 script using /epic-scan slash command"""
...
def main():
    ...
    print("Generating Wave 4 Phase 3 scripts...")
    print(f"Epics: {EPICS}")
    ...
    for epic_id in EPICS:
        ...
        script_path = f"scripts/wave4/_p3_{epic_id}.sh"
    ...
    launcher_path = "scripts/wave4/launch_phase3_all_screen.sh"
    ...
    print("   gcloud compute scp scripts/wave4/_p3_*.sh scripts/wave4/launch_phase3_all_screen.sh v12-test-golden-v2:/home/malhitticrypto/universal-or-strategy/ --zone=us-central1-a")
    ...
    print("   .\\scripts\\verify_phase_completion.ps1 -Phase 3 -Epics 126,127,128,129,130,131,132,133,134,135")
