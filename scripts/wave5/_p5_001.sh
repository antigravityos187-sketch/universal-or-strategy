...
# Wave: 5 (Pilot Test)
# Method: Building-blocks (copied from wave4/_p5_001.sh)
...
**SURGICAL ONLY MANDATE (V12.34)**: Touch ONLY the target method. NO pre-existing fixes, NO adjacent changes, NO "while we're here" improvements.
