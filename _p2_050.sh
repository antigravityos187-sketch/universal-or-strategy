...
export BOBSHELL_API_KEY='bob_prod_bob-admin_5WciJzobAhwqBg9mGnufiVpP8YQgvkxKSa2qkm6RhvBX7zHGmKLvkMzCPxorABYn17ecfDWFAXNS8VH7R1kJvt88_4esgR8gBMyHk9tfni1DdvaZZRYAroncZNrj9SXack9GC'
mkdir -p docs/brain/EPIC-W7-050
mkdir -p logs/wave7/phase2

if [ ! -f "docs/brain/EPIC-W7-050/01-scope-boundary.md" ]; then
    echo "BLOCKED: Phase 1.5 not complete"
    exit 1
fi

cat > /tmp/phase2_msg_050.txt << 'EOFMSG'
Execute Phase 2 (Architecture Planning) for EPIC-W7-050.
...
Input: docs/brain/EPIC-W7-050/01-scope-boundary.md
...
4. Write docs/brain/EPIC-W7-050/02-architecture-plan.md using execute_command
...
bob --yolo --chat-mode plan "$(cat /tmp/phase2_msg_050.txt)" 2>&1 | tee logs/wave7/phase2/EPIC-W7-050.log
echo "DONE_EXIT=$?"
