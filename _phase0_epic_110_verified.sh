...
# Set API key
export BOB_API_KEY_FILE="$HOME/.bob/api-keys/bob (2).json"
...
bob --mode advanced \
    --message "Execute Phase 0 (Hotspot Analysis) for EPIC-CCN-110.
...
2. get_blast_radius(repo='universal-or-strategy', symbol='HandleFlatPositionUpdate')
3. get_call_hierarchy(repo='universal-or-strategy', symbol_id='HandleFlatPositionUpdate')
4. get_symbol_complexity(repo='universal-or-strategy', symbol_id='HandleFlatPositionUpdate')

### Step 2: Write 00-hotspots.md
Use write_to_file tool to create docs/brain/EPIC-CCN-110/00-hotspots.md with:
...
Use write_to_file tool to create docs/brain/EPIC-CCN-110/manifest.json:
```json
{
  "epic_id": "EPIC-CCN-110",
  "method": "HandleFlatPositionUpdate",
  "file": "src/V12_002.cs",
  "complexity": 37,
  "phases": {
...
1. read_file docs/brain/EPIC-CCN-110/00-hotspots.md
2. read_file docs/brain/EPIC-CCN-110/manifest.json
