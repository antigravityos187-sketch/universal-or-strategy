...
You are executing Phase 2 (Architecture Planning) for EPIC-CCN-113.

**Input Artifact**: Read `docs/brain/EPIC-CCN-113/01-scope-boundary.md` for scope definition.

**Your Task**: Create detailed architecture plan for the extraction.

**Output Requirements**:
1. Create `docs/brain/EPIC-CCN-113/02-architecture-plan.md` with:
...
bob --yolo /epic-plan EPIC-CCN-113 2>&1 | tee logs/phase2/EPIC-CCN-113.log
echo "DONE_EXIT=$?"
