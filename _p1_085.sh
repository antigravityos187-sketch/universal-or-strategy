...
You are in **Plan mode** for Phase 1 (Scope Definition) of epic EPIC-W7-085.
...
1. **Read Input**: Read docs/brain/EPIC-W7-085/00-hotspots.md
2. **Define Scope**: 
   - What code will be extracted?
   - What will remain in the original method?
   - What are the boundaries?
3. **Write Output**: Create docs/brain/EPIC-W7-085/00-scope.md with:
