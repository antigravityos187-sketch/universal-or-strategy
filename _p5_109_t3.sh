...
cat > /tmp/phase5_msg_109_t3.txt << 'EOFMSG'
You are executing TICKET-3 for EPIC-CCN-109.

**Input**: Read `docs/brain/EPIC-CCN-109/04-tickets.md`, locate TICKET-3
...
**Output**: `docs/brain/EPIC-CCN-109/ticket-3-completion.md` with self-validation results
...
bob --yolo --chat-mode v12-engineer "$(cat /tmp/phase5_msg_109_t3.txt)" 2>&1 | tee logs/phase5/EPIC-CCN-109-T3.log
echo "DONE_EXIT=$?"
