...
for epic_num in "${!EPICS[@]}"; do
    ...
    session_name="phase1_epic_${epic_num}"
    script_name="_p1_${epic_num}.sh"
...
echo ""
echo "=== All 9 Phase 1 epics launched ==="
echo ""
echo "Monitor with:"
echo "  screen -ls                    # List all sessions"
echo "  screen -r phase1_epic_107     # Attach to specific epic"
echo "  Ctrl+A, D                     # Detach from session"
echo ""
echo "Check progress:"
echo "  ls -lh docs/brain/EPIC-CCN-*/00-scope.md"
