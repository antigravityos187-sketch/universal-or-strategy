...
# Set API key
export BOB_API_KEY_FILE="$HOME/.bob/api-keys/bob (1).json"
...
bob --mode advanced \
    --message "Execute Phase 0 (Hotspot Analysis) for EPIC-CCN-109.
...
Use write_to_file tool to create docs/brain/EPIC-CCN-109/00-hotspots.md with:
...
Use write_to_file tool to create docs/brain/EPIC-CCN-109/manifest.json:
```json
{
...
1. read_file docs/brain/EPIC-CCN-109/00-hotspots.md
2. read_file docs/brain/EPIC-CCN-109/manifest.json
