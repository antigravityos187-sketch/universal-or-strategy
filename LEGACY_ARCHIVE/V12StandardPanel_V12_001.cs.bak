...
{
    public class V12StandardPanel_V12_001 : Indicator
    {
        #region Variables
        ...
        static V12StandardPanel_V12_001()
        {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name = "V12 Standard Panel V12_001";
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private V12StandardPanel_V12_001[] cacheV12StandardPanel_V12_001;
		public V12StandardPanel_V12_001 V12StandardPanel_V12_001(int ipcPort, bool autoConnect, int panelWidth)
		{
			return V12StandardPanel_V12_001(Input, ipcPort, autoConnect, panelWidth);
		}

		public V12StandardPanel_V12_001 V12StandardPanel_V12_001(ISeries<double> input, int ipcPort, bool autoConnect, int panelWidth)
		{
			if (cacheV12StandardPanel_V12_001 != null)
				for (int idx = 0; idx < cacheV12StandardPanel_V12_001.Length; idx++)
					if (cacheV12StandardPanel_V12_001[idx] != null && cacheV12StandardPanel_V12_001[idx].IpcPort == ipcPort && cacheV12StandardPanel_V12_001[idx].AutoConnect == autoConnect && cacheV12StandardPanel_V12_001[idx].PanelWidth == panelWidth && cacheV12StandardPanel_V12_001[idx].EqualsInput(input))
						return cacheV12StandardPanel_V12_001[idx];
			return CacheIndicator<V12StandardPanel_V12_001>(new V12StandardPanel_V12_001(){ IpcPort = ipcPort, AutoConnect = autoConnect, PanelWidth = panelWidth }, input, ref cacheV12StandardPanel_V12_001);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.V12StandardPanel_V12_001 V12StandardPanel_V12_001(int ipcPort, bool autoConnect, int panelWidth)
		{
			return indicator.V12StandardPanel_V12_001(Input, ipcPort, autoConnect, panelWidth);
		}

		public Indicators.V12StandardPanel_V12_001 V12StandardPanel_V12_001(ISeries<double> input , int ipcPort, bool autoConnect, int panelWidth)
		{
			return indicator.V12StandardPanel_V12_001(input, ipcPort, autoConnect, panelWidth);
		}
	}
