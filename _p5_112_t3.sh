...
cat > /tmp/phase5_msg_112_t3.txt << 'EOFMSG'
You are executing TICKET-3 for EPIC-CCN-112.

**Input**: Read `docs/brain/EPIC-CCN-112/04-tickets.md`, locate TICKET-3
...
**Output**: `docs/brain/EPIC-CCN-112/ticket-3-completion.md` with self-validation results
...
bob --yolo --chat-mode v12-engineer "$(cat /tmp/phase5_msg_112_t3.txt)" 2>&1 | tee logs/phase5/EPIC-CCN-112-T3.log
echo "DONE_EXIT=$?"
