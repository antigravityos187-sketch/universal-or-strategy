...
namespace NinjaTrader.NinjaScript.Indicators
{
    public class V12StandardPanel_V12_001_Dev : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "V12 STANDARD - Vertical Sidebar Dev Surface";
                Name = "V12 Standard Panel V12_001_Dev";
        ...
        private void CreatePanel()
        {
            ...
            try
            {
                ...
                rootContainer = new Grid { ClipToBounds = true, Width = PanelWidth }; // V12.7: Prevent overflow, V12.12: Fixed width
                ...
                lock (tcpLock)
                {
                    ...
                    foreach(int p in ports)
                    {
                        try 
                        {
                            ...
                            isConnected = true;
                            IpcPort = p; // Update active port reference
                            success = true;
                    ...
                    if (!success) throw new Exception("Could not connect to Strategy on port 5000 or 5001");
