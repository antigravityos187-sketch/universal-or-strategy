# EPIC-W7-045 — Phase 1.5: Scope Boundary Validation
...
**`OnKeyDown` + 2 new helper methods (to be named in Phase 2)**
...
- `AttachHotkeys` — confirmed not modified by this epic
- `DetachHotkeys` — confirmed not modified by this epic
...
- **Source analyzed:** `docs/brain/EPIC-W7-045/00-scope.md` (Phase 1 output)
...
- **Scope statement from Phase 1:** The scope boundary for EPIC-W7-045 is limited to the single method
`OnKeyDown` (lines 391–426, `src/V12_002.UI.Callbacks.cs`). This boundary
encompasses:

- The method declaration and its four conditi
