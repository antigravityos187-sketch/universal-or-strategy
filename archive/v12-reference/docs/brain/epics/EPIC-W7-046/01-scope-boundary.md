# EPIC-W7-046 — Phase 1.5: Scope Boundary Validation
...
**Input:** docs/brain/EPIC-W7-046/00-scope.md
...
**`HandleChartClick_ConvertPrice` + 2 new helper methods (to be named in Phase 2)**
...
- `OnChartClick` — confirmed not modified by this epic
...
- **Source analyzed:** `docs/brain/EPIC-W7-046/00-scope.md` (Phase 1 output)
...
- **Scope statement from Phase 1:** The **scope boundary** encompasses exactly one method:
`HandleChartClick_ConvertPrice` in `src/V12_002.UI.Callbacks.cs` (lines 272–353).

All analysis, extraction planning, and refactor work in subseq
