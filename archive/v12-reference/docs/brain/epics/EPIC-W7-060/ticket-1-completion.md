# Ticket 1 Completion -- EPIC-W7-060
...
**parent_method:** SweepTrackedOrders
**cyc_parent_now:** 1
**cyc_achieved:** 1
**build_passed:** true
**tests_written:** 0
...
Method `SweepTrackedOrders` in `src/V12_002.SIMA.Lifecycle.cs` is CYC=0 which is within CYC<=8 target.
