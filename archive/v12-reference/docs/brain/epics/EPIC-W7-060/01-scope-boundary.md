# EPIC-W7-060 — Phase 1.5: Scope Boundary Validation
...
**Input:** docs/brain/EPIC-W7-060/00-scope.md
...
**`SweepTrackedOrders` + 2 new helper methods (to be named in Phase 2)**
...
- **Source analyzed:** `docs/brain/EPIC-W7-060/00-scope.md` (Phase 1 output)
...
- **Scope statement from Phase 1:** The **scope boundary** for EPIC-W7-060 is drawn around the single method
`SweepTrackedOrders` in `src/V12_002.SIMA.Lifecycle.cs` (lines 1308–1353).

Everything outside this boundary — including the di
