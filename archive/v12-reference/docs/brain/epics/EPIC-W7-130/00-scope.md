...
**Thought 1**: `SymmetryGuardCascadeFollowerCleanup` in `src/V12_002.Symmetry.Replace.cs` has CYC=0, which exceeds the Jane Street threshold of <=8. The scope must be strictly limited to extracting helper methods from `SymmetryGuardCascadeFollowerCleanup` only -- no scope creep.
...
| **Output** | docs/brain/EPIC-W7-130/00-scope.md |
