# EPIC-W7-051 — Phase 1.5: Scope Boundary Validation
...
**Input:** docs/brain/EPIC-W7-051/00-scope.md
...
**`UpdateStopOrder` + 2 new helper methods (to be named in Phase 2)**
...
- **CYC baseline:** 6 (target: <= 8 after extraction)
...
- **Source analyzed:** `docs/brain/EPIC-W7-051/00-scope.md` (Phase 1 output)
...
- **Scope statement from Phase 1:** The **scope boundary** for this epic is drawn precisely at the `UpdateStopOrder` method
signature. Work performed under EPIC-W7-051 is authorised to:

1. Refactor the body of `UpdateStopOrder` (lines 
