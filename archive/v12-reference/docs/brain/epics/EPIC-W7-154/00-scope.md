...
**Thought 1**: `TryHandleFleet_LongShort` in `src/V12_002.UI.IPC.Commands.Fleet.cs` has CYC=3, which exceeds the Jane Street threshold of <=8. The scope must be strictly limited to extracting helper methods from `TryHandleFleet_LongShort` only -- no scope creep.
...
| **Output** | docs/brain/EPIC-W7-154/00-scope.md |
