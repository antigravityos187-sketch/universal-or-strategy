# EPIC-W7-138 — Phase 1.5: Scope Boundary Validation
...
**Input:** docs/brain/EPIC-W7-138/00-scope.md
...
**`ManageTrail_RunPerTradeBranches` + 5 new helper methods (to be named in Phase 2)**
...
- **Source analyzed:** `docs/brain/EPIC-W7-138/00-scope.md` (Phase 1 output)
...
- **Scope statement from Phase 1:** > **Only `ManageTrail_RunPerTradeBranches` and its new extracted helper methods are in scope.**

This epic covers exclusively the cyclomatic complexity reduction of `ManageTrail_RunPerTradeBranches` i
