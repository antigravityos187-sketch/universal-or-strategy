# EPIC-W7-108 — Phase 1.5: Scope Boundary Validation
...
**Input:** docs/brain/EPIC-W7-108/00-scope.md
...
**`DrainPhotonQueuesOnShutdown` + 5 new helper methods (to be named in Phase 2)**

The scope is strictly limited to:
1. The target method: `DrainPhotonQueuesOnShutdown` in `V12_002.SIMA.Lifecycle.cs`
...
- **Source analyzed:** `docs/brain/EPIC-W7-108/00-scope.md` (Phase 1 output)
...
- **Blast radius:** Limited to `V12_002.SIMA.Lifecycle.cs` + private helpers (same partial class)
