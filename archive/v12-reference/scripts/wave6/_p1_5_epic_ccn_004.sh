...
# Output: docs/brain/EPIC-CCN-004/01-scope-boundary.md
...
can_execute, reason = verify_can_execute('$EPIC_ID', '$PHASE', '$jessica')
if not can_execute:
...
started, reason = start_phase_execution('$EPIC_ID', '$PHASE', '$jessica')
if not started:
...
recorded, reason = fail_phase_execution('$EPIC_ID', '$PHASE', '$jessica', '$ERROR_MSG')
