...
# Output: docs/brain/EPIC-CCN-076/01-scope-boundary.md

set -euo pipefail

EPIC_ID="EPIC-CCN-076"
rakaarababa="rakaarababa"
PHASE="1.5"

echo "=========================================="
echo "V12.52 Phase 1.5: Scope Boundary Validation"
echo "Epic: $EPIC_ID"
echo "Agent: $rakaarababa"
echo "=========================================="
...
can_execute, reason = verify_can_execute('$EPIC_ID', '$PHASE', '$rakaarababa')
if not can_execute:
...
started, reason = start_phase_execution('$EPIC_ID', '$PHASE', '$rakaarababa')
if not started:
...
recorded, reason = fail_phase_execution('$EPIC_ID', '$PHASE', '$rakaarababa', '$ERROR_MSG')
