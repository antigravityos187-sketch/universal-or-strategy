...
# Output: docs/brain/EPIC-CCN-022/01-scope-boundary.md

set -euo pipefail

EPIC_ID="EPIC-CCN-022"
davidgreen77="davidgreen77"
PHASE="1.5"

echo "=========================================="
echo "V12.52 Phase 1.5: Scope Boundary Validation"
echo "Epic: $EPIC_ID"
echo "Agent: $davidgreen77"
echo "=========================================="
...
can_execute, reason = verify_can_execute('$EPIC_ID', '$PHASE', '$davidgreen77')
if not can_execute:
...
started, reason = start_phase_execution('$EPIC_ID', '$PHASE', '$davidgreen77')
if not started:
...
recorded, reason = fail_phase_execution('$EPIC_ID', '$PHASE', '$davidgreen77', '$ERROR_MSG')
