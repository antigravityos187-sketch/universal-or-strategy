...
- Method 1: ProcessSingleFleetRMAAccount
- Method 2: ExecuteFleetOrder
- Method 3: ValidateFleetState
- File: src/V12_002.SIMA.Execution.cs
- Complexity: 16, 10, 10 (target: all ≤8)
...
- **Method 3**: ValidateFleetState
- **File**: src/V12_002.SIMA.Execution.cs
- **Cyclomatic Complexity**: 16, 10, 10
...
{
  "epic_id": "EPIC-004",
  "methods": ["ProcessSingleFleetRMAAccount", "ExecuteFleetOrder", "ValidateFleetState"],
  "file": "src/V12_002.SIMA.Execution.cs",
  "complexity": [16, 10, 10],
  "phases": {
    "0": {
