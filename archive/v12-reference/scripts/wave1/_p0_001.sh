...
- Method 1: PropagateMaster_IdentifyMove
- Method 2: PropagateMaster_HandleRejection  
- Method 3: PropagateMaster_SyncTargets
- File: src/V12_002.Orders.Callbacks.Propagation.cs
- Complexity: 18, 11, 10 (target: all ≤8)
...
2. get_blast_radius(repo='universal-or-strategy', symbol='PropagateMaster_IdentifyMove')
3. get_call_hierarchy(repo='universal-or-strategy', symbol_id='PropagateMaster_IdentifyMove')
4. get_symbol_complexity(repo='universal-or-strategy', symbol_id='PropagateMaster_IdentifyMove')
...
- **Method 3**: PropagateMaster_SyncTargets
- **File**: src/V12_002.Orders.Callbacks.Propagation.cs
- **Cyclomatic Complexity**: 18, 11, 10
...
{
  "epic_id": "EPIC-001",
  "methods": ["PropagateMaster_IdentifyMove", "PropagateMaster_HandleRejection", "PropagateMaster_SyncTargets"],
  "file": "src/V12_002.Orders.Callbacks.Propagation.cs",
  "complexity": [18, 11, 10],
  "phases": {
    "0": {
