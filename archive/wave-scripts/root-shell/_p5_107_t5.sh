...
cat > /tmp/phase5_msg_107_t5.txt << 'EOFMSG'
You are executing TICKET-5 for EPIC-CCN-107.

**Input**: Read `docs/brain/EPIC-CCN-107/04-tickets.md`, locate TICKET-5
...
**Output**: `docs/brain/EPIC-CCN-107/ticket-5-completion.md` with self-validation results
...
bob --yolo --chat-mode v12-engineer "$(cat /tmp/phase5_msg_107_t5.txt)" 2>&1 | tee logs/phase5/EPIC-CCN-107-T5.log
echo "DONE_EXIT=$?"
