...
cat > /tmp/phase5_msg_108_t1.txt << 'EOFMSG'
You are executing TICKET-1 for EPIC-CCN-108.

**Input**: Read `docs/brain/EPIC-CCN-108/04-tickets.md`, locate TICKET-1
...
**Output**: `docs/brain/EPIC-CCN-108/ticket-1-completion.md` with self-validation results
...
bob --yolo --chat-mode v12-engineer "$(cat /tmp/phase5_msg_108_t1.txt)" 2>&1 | tee logs/phase5/EPIC-CCN-108-T1.log
echo "DONE_EXIT=$?"
