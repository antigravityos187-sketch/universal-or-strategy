...
cat > /tmp/phase1_msg_106.txt << 'EOFMSG'
...
3. Write docs/brain/EPIC-W7-106/00-scope.md using execute_command
...
bob --yolo --chat-mode v12-phase1-scope "$(cat /tmp/phase1_msg_106.txt)" 2>&1 | tee logs/wave7/phase1/EPIC-W7-106.log
echo "DONE_EXIT=$?"
