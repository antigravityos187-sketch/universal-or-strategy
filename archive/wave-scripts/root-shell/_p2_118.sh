...
export BOBSHELL_API_KEY='bob_prod_bob-admin_2SC4VtHL6svY4W1mLFsfLCztVEc6wzuuoXFevyjQCEEojgcH7LLtWUBQiwZ9Q2q6cy8Hmrurpm1KkpXqaoSiKEez_5Vu6PjnTrETTRRjdjQ74VjoMJ365drmPkr4qN5CE6ztJ'
mkdir -p docs/brain/EPIC-W7-118
mkdir -p logs/wave7/phase2

if [ ! -f "docs/brain/EPIC-W7-118/01-scope-boundary.md" ]; then
    echo "BLOCKED: Phase 1.5 not complete"
    exit 1
fi

cat > /tmp/phase2_msg_118.txt << 'EOFMSG'
Execute Phase 2 (Architecture Planning) for EPIC-W7-118.
...
Input: docs/brain/EPIC-W7-118/01-scope-boundary.md
...
4. Write docs/brain/EPIC-W7-118/02-architecture-plan.md using execute_command
...
bob --yolo --chat-mode plan "$(cat /tmp/phase2_msg_118.txt)" 2>&1 | tee logs/wave7/phase2/EPIC-W7-118.log
echo "DONE_EXIT=$?"
