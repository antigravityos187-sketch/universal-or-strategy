...
cat > /tmp/phase5v_msg_109_t4.txt << 'EOFMSG'
You are performing INDEPENDENT VALIDATION (Tier 2) for TICKET-4 of EPIC-CCN-109.

**Input**: Read `docs/brain/EPIC-CCN-109/ticket-4-completion.md` and original ticket spec
...
**Output**: `docs/brain/EPIC-CCN-109/ticket-4-verification.md` with verdict and detailed findings
...
bob --yolo --chat-mode advanced "$(cat /tmp/phase5v_msg_109_t4.txt)" 2>&1 | tee logs/phase5v/EPIC-CCN-109-T4-VALIDATION.log
echo "DONE_EXIT=$?"
