...
cat > /tmp/phase5v_msg_107_t2.txt << 'EOFMSG'
You are performing INDEPENDENT VALIDATION (Tier 2) for TICKET-2 of EPIC-CCN-107.

**Input**: Read `docs/brain/EPIC-CCN-107/ticket-2-completion.md` and original ticket spec
...
**Output**: `docs/brain/EPIC-CCN-107/ticket-2-verification.md` with verdict and detailed findings
...
bob --yolo --chat-mode advanced "$(cat /tmp/phase5v_msg_107_t2.txt)" 2>&1 | tee logs/phase5v/EPIC-CCN-107-T2-VALIDATION.log
echo "DONE_EXIT=$?"
