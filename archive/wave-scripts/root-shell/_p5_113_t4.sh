...
cat > /tmp/phase5_msg_113_t4.txt << 'EOFMSG'
You are executing TICKET-4 for EPIC-CCN-113.

**Input**: Read `docs/brain/EPIC-CCN-113/04-tickets.md`, locate TICKET-4
...
**Output**: `docs/brain/EPIC-CCN-113/ticket-4-completion.md` with self-validation results
...
bob --yolo --chat-mode v12-engineer "$(cat /tmp/phase5_msg_113_t4.txt)" 2>&1 | tee logs/phase5/EPIC-CCN-113-T4.log
echo "DONE_EXIT=$?"
