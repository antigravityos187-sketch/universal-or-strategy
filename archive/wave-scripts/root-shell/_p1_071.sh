...
3. Write docs/brain/EPIC-W7-071/00-scope.md using execute_command
...
bob --yolo --chat-mode v12-phase1-scope "$(cat /tmp/phase1_msg_071.txt)" 2>&1 | tee logs/wave7/phase1/EPIC-W7-071.log
echo "DONE_EXIT=$?"
