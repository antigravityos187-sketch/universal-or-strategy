...
cat > /tmp/phase5v_msg_111_t1.txt << 'EOFMSG'
You are performing INDEPENDENT VALIDATION (Tier 2) for TICKET-1 of EPIC-CCN-111.

**Input**: Read `docs/brain/EPIC-CCN-111/ticket-1-completion.md` and original ticket spec
...
**Output**: `docs/brain/EPIC-CCN-111/ticket-1-verification.md` with verdict and detailed findings
...
bob --yolo --chat-mode advanced "$(cat /tmp/phase5v_msg_111_t1.txt)" 2>&1 | tee logs/phase5v/EPIC-CCN-111-T1-VALIDATION.log
echo "DONE_EXIT=$?"
