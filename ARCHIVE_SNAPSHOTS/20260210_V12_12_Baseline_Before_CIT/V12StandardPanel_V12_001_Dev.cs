...
{
    public class V12StandardPanel_V12_001_Dev : Indicator
    {
        #region Variables
        ...
        static V12StandardPanel_V12_001_Dev()
        {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name = "V12 Standard Panel V12_001 Dev";
        ...
        private void CreatePanel()
        {
            ...
            try
            {
                ...
                rootContainer = new Grid { ClipToBounds = true, Width = PanelWidth, HorizontalAlignment = HorizontalAlignment.Right }; // V12.7: Prevent overflow, V12.12: Fixed width / Right Aligned
                ...
                floatingAnchor = CreateButton("âš“", 30, CyanBg, CyanFg, CyanBorder);
        ...
        private void UpdateFleetButtonText()
        {
            ...
            if (count == 0)
                fleetSelectButton.Content = "FLEET: None Selected â–¼";
            else if (count == total)
                fleetSelectButton.Content = "FLEET: ALL Accounts â–¼";
            else
                fleetSelectButton.Content = $"FLEET: {count} of {total} â–¼";
        }
        ...
        private Border CreateSection0_Identity()
        {
            ...
            {
                Content = "FLEET: Select Accounts â–¼",
                Height = 22,
                FontSize = 10,
                FontFamily = new FontFamily("Consolas"),
                Background = BgSlate,
            ...
            Button closeBtnRow = CreateButton("âœ•", 28, RedBg, Brushes.White, RedBorder);
            ...
            closeBtnRow.Click += (s, e) => { if (contentBody != null) contentBody.Visibility = Visibility.Collapsed; };
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private V12StandardPanel_V12_001_Dev[] cacheV12StandardPanel_V12_001_Dev;
		public V12StandardPanel_V12_001_Dev V12StandardPanel_V12_001_Dev(int ipcPort, bool autoConnect, int panelWidth)
		{
			return V12StandardPanel_V12_001_Dev(Input, ipcPort, autoConnect, panelWidth);
		}

		public V12StandardPanel_V12_001_Dev V12StandardPanel_V12_001_Dev(ISeries<double> input, int ipcPort, bool autoConnect, int panelWidth)
		{
			if (cacheV12StandardPanel_V12_001_Dev != null)
				for (int idx = 0; idx < cacheV12StandardPanel_V12_001_Dev.Length; idx++)
					if (cacheV12StandardPanel_V12_001_Dev[idx] != null && cacheV12StandardPanel_V12_001_Dev[idx].IpcPort == ipcPort && cacheV12StandardPanel_V12_001_Dev[idx].AutoConnect == autoConnect && cacheV12StandardPanel_V12_001_Dev[idx].PanelWidth == panelWidth && cacheV12StandardPanel_V12_001_Dev[idx].EqualsInput(input))
						return cacheV12StandardPanel_V12_001_Dev[idx];
			return CacheIndicator<V12StandardPanel_V12_001_Dev>(new V12StandardPanel_V12_001_Dev(){ IpcPort = ipcPort, AutoConnect = autoConnect, PanelWidth = panelWidth }, input, ref cacheV12StandardPanel_V12_001_Dev);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.V12StandardPanel_V12_001_Dev V12StandardPanel_V12_001_Dev(int ipcPort, bool autoConnect, int panelWidth)
		{
			return indicator.V12StandardPanel_V12_001_Dev(Input, ipcPort, autoConnect, panelWidth);
		}

		public Indicators.V12StandardPanel_V12_001_Dev V12StandardPanel_V12_001_Dev(ISeries<double> input , int ipcPort, bool autoConnect, int panelWidth)
		{
			return indicator.V12StandardPanel_V12_001_Dev(input, ipcPort, autoConnect, panelWidth);
		}
	}
